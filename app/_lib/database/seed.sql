...
, 60),
(4, 'Winter Landscape with Ice Skaters', '/images/the-threatened-swan.png', 1, 'Hendrick Avercamp', 'A frozen river dotted by people at play or at work is the subject of this winter landscape painted by Hendrick Avercamp. Inspect it down to the smallest detail: a man slipping, a bare bottom, and skating couples.'
, 50)
